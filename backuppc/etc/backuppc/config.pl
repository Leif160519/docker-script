...
# redirection and pipes; put that in a script if you need it.
#
$Conf{SmbClientFullCmd} = '$smbClientPath \\\\$host\\$shareName $I_option -U $userName -E -d 1 -c tarmode\\ full -mSMB3 -Tc$X_option - $fileList';
...
#
$Conf{EMailFromUserName} = 'alert@example.com';
...
# name (eg: "admin@mydomain.com").
#
$Conf{EMailAdminUserName} = 'alert@example.com';
